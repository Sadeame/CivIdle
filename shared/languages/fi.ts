export const FI = {
   ...
   TranslatorCredit: "Sadeame",
   Translators: "Kääntäjä",
   Language: "Kieli",
   TechnologyPrerequisite: "Edellytys",
   TechnologyNoPrerequisite: "Ei Edellytystä",
   Fire: "Tuli",
   Logging: "Metsuri",
   Shelter: "Suoja",
   StoneTools: "Kivi työkalut",
   Masonry: "Muuraus",
   Herding: "Paimennus",
   Farming: "Maanviljely",
   BronzeTech: "Pronssikausi",
   Housing: "Asunnot",
   Counting: "Laskenta",
   HorsebackRiding: "Ratsastus",
   Metallurgy: "Metallurgia",
   Stateship: "Valtiovalta",
   Arithmetic: "Laskuoppi",
   Writing: "Kirjoitus",
   Shamanism: "Shamanismi",
   RoadAndWheel: "Tie & Pyörä",
   Astronomy: "Tähtitiede",
   IronTech: "Rauta",
   Construction: "Rakennustyöt",
   Music: "Musiikki",
   Cloth: "Kangas",
   GarmentWorkshop: "Vaatepaja",
   FurnitureWorkshop: "Huonekaluverstas",
   Garment: "Vaate",
   Calendar: "Kalenteri",
   Engineering: "Tekniikka",
   Gold: "Kulta",
   PreciousMetal: "Arvometalli",
   Market: "Marketti",
   MarketDesc: "Vaihda resursseja toisiin, saatavilla olevat resurssit vaihtuvat tunneittain. Exchange a resource to another, available resources update every hour",
   CityState: "Kaupunkivaltio",
   ...
   Oil: "Öljy",
   NaturalGas: "Maakaasu",
   NaturalGasWell: "Maakaasulähde",
   OilRefinery: "Öljynjalostamo",
   Petrol: "Bemsoono",
   Aluminum: "Alumiini",
   Theater: "Teatteri",
   KnightCamp: "Ritari Leiri",
   CannonWorkshop: "Kanuunatehdas",
   DynamiteWorkshop: "Dynamiittipaja",
   LensWorkshop: "Linssitehdas",
   Lens: "Linssi",
   GunpowderMill: "Ruutitehdas",
   Cannon: "Kanuuna",
   Dynamite: "Dynamiitti",
   Gunpowder: "Ruuti",
   Coal: "Hiili",
   ...
   Geography: "Maantiede",
   Physics: "Fysiikka",
   Feudalism: "Feodalismi",
   Theocracy: "Teokratia",
   Education: "Koulutus",
   Navigation: "Navigaatio",
   CivilService: "Siviilihallinto",
   Cathedral: "Katedraali",
   Printing: "Painatus",
   Exploration: "Tutkimusmatkailu",
   ...
   Sports: "Urheilu",
   PublishingHouse: "Kustantamo",
   MagazinePublisher: "Lehden Julkaisija",
   HolyEmpire: "Pyhä Keisarikunta",
   Renaissance: "Renessanssi",
   PrintingPress: "Painokone",
   PrintingHouse: "Painotalo",
   Book: "Kirja",
   Chemistry: "Kemia",
   Enlightenment: "Valaistuminen",
   Firearm: "Ase",
   Optics: "Optiikka",
   PrivateOwnership: "Yksityisomistus",
   Revolution: "Vallankumous",
   Constitution: "Perustuslaki",
   Library: "Kirjasto",
   Engine: "Moottori",
   SteamEngine: "Höyrykone",
   LocomotiveFactory: "Veturitehdas",
   TankFactory: "Tankkitehdas",
   Tank: "Tankki",
   Train: "Juna",
   Capitalism: "Kapitalismi",
   Alloy: "Seos",
   Rifling: "Rihlaus",
   Colonialism: "Kolonialismi",
   RapidFire: "Sarjatuli",
   ...
   Refinery: "Jalostamo",
   Combustion: "Palamisreaktio",
   Imperialism: "Imperialismi",
   StockMarket: "Pörssimarkkinat",
   Electricity: "Sähkö",
   Electrolysis: "Elektrolyysi",
   GasPipeline: "Kaasulinja",
   Urbanization: "Kaupungistuminen",
   Aeroplane: "Lentokone",
   AtomTheory: "Atomiteoria",
   Synthetics: "Synteettiset",
   MotionPicture: "Elokuva",
   Assembly: "Kokoonpano",
   Medicine: "Lääketiede",
   Hospital: "Sairaala",
   ...
   Vaccine: "Rokotus",
   Refrigeration: "Kylmäsäilytys",
   SpaceProgram: "Avaruusohjelma",
   Television: "Televisio",
   Tourism: "Turismi",
   Skyscrapper: "Pilvenpiirtäjä",
   Computer: "Tietokone",
   Globalization: "Globalisaatio",
   UnitedNation: "Yhdistynyt Kansa",
   Metropolitan: "Suurkaupunki",
   NuclearFission: "Ydinfissio",
   Internet: "Internet",
   Nanotechnology: "Nanoteknologia",
   Genetics: "Perinnöllisyystiede",
   Conglomerate: "Yhtymä",
   Robotics: "Robotiikka",
   SocialNetwork: "Sosiaalinenverkosto",
   Smartphone: "Älypuhelin",
   UniversalHealthcare: "Yleinen Terveydenhoito",
   VentureCapital: "Riskipääoma",
   ArtificialIntelligence: "Tekoäly",
   CloudComputing: "Pilvipalvelu",
   VirtualReality: "Virtuaalitodellisuus",
   Cryptocurrency: "Kryptovaluutta",
   ViewTechnology: "Tarkastele",
   Headquarter: "Päämaja",
   UnexploredTile: "Tutkimaton Laatta",
   Tile: "Laatta",
   Deposit: "Esiintymä",
   UniqueBuildings: "Ainutlaatuiset Rakennukset",
   RequiredDeposit: "Tarvitut esiintymät",
   NoDepositDesc:
      "Tällä laatalla ei ole esiintymää. Voit löytää lisää esiintymiä tutkimalla lisää teknologioita. There's no deposit on this tile. More deposits may be discovered when you unlock new technologies",
   UnlockBuilding: "Avaa",
   UpgradeBuilding: "Päivitä",
   RevealDeposit: "Paljasta",
   BuildingMultipliers: "Tehosta",
   BuildingANew: "Rakenna",
   BuildingSearchText: "Kirjoita rakennuksen tai resurrssin nimi etsiäksesi. Type a building or resource name to search",
   Worker: "Työläinen",
